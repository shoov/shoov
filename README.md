...
Clone the project from [GitHub](https://github.com/Gizra/boom).
...
6. Makes a symlink within the /www/profiles directory to the /boom
   directory.
7. Run the Drupal installer (Drush) using the Boom profile.
