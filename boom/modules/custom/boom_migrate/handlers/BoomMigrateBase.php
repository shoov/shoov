...
/**
 * @file
 * Contains \BoomMigration.
 */

abstract class BoomMigrateBase extends Migration {
  ...
  public function __construct() {
    ...
    if (!in_array($this->entityType, array('node', 'taxonomy_term'))) {
      throw new Exception('\BoomMigration supports only nodes and terms.');
    }
  ...
  protected function getMigrateDirectory() {
    return variable_get('boom_migrate_directory', FALSE) ? variable_get('boom_migrate_directory') : drupal_get_path('module', 'boom_migrate');
  }
}
