...
drush sql-query 'UPDATE field_data_field_github_access_token SET field_github_access_token_value = "helena" WHERE entity_id NOT IN (SELECT uid FROM users WHERE name = "HelenaEksler");'
